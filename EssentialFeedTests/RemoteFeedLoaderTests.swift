...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "www.youtube.com")!)
        let item1JSON = ["id": item1.id.uuidString, "image": item1.imageURL.absoluteString]
        
        let item2 = FeedItem(id: UUID(), description: "description", location: "location", imageURL: URL(string: "www.youtube.com")!)
        let item2JSON = [
